document.addEventListener('DOMContentLoaded', function() {
    ...
    if (transferApplicationForm) { // Only run this block if the form exists on the page
        ...
        function validateForm() {
            ...
            isValid = validateInputField('name', 'nama_error', /^[a-zA-Z\s]+$/, 'Nama hanya boleh mengandungi huruf dan ruang.') && isValid;
            isValid = validateInputField('studentIC', 'kp_error', /^\d{12}$/, 'No. Kad Pengenalan mestilah 12 digit.') && isValid;
            isValid = validateInputField('studentId', 'np_error', /^\d{10}$/, 'No. Pelajar mestilah 10 digit.') && isValid;
            ...
            isValid = validateInputField('program_dipohon', 'program_error') && isValid;            isValid = validateInputField('mod_pengajian_baru', 'mod_pengajian_baru_error') && isValid;
